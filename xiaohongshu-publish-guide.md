...
```
E:\Program Files\ClawX\resources\openclaw\skills\xiaohongshu-skills
```
...
```bash
# 1. 进入 ClawX 技能目录
cd E:\Program Files\ClawX\resources\openclaw\skills
...
3. 解压到 `E:\Program Files\ClawX\resources\openclaw\skills\xiaohongshu-skills`
4. 打开终端，进入技能目录
5. 运行 `uv sync` 安装依赖
...
```bash
cd "E:\Program Files\ClawX\resources\openclaw\skills\xiaohongshu-skills"
...
```batch
@echo off
set XHS_SKILLS=E:\Program Files\ClawX\resources\openclaw\skills\xiaohongshu-skills
...
- 技能位置：`E:\Program Files\ClawX\resources\openclaw\skills\xiaohongshu-skills`
- 小红书创作平台：https://creator.xiaohongshu.com

---

*文档生成时间：2026-03-23*
*适用技能版本：xiaohongshu-skills v1.0.0*
